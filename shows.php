...
$previewVideoThumb = $preveiw->tvShowPreview();  
...
<!-- home content section-->
	     	<article class="uk-article video-home_content">
			    <h1 class="uk-article-title "><a class="uk-link-reset" href=""><?php echo $previewVideoThumb[1]?></a></h1>
...
<!--********************************************************************** -->
	<!--videos section-->
		...
		echo $preveiwcategory->showAllTvShowCategories();
		?>
	<!--videos section-->
<!--********************************************************************** -->
