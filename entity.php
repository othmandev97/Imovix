<?php 
    ...
    $previewVideoThumb = $preveiw->createPreviwVideo($entity);   
    ...
    <!-- home content section-->
        <article class="uk-article video-home_content">
            ...
            <div class="uk-grid-small uk-child-width-auto" uk-grid>
                <div>
                     <span class="uk-button uk-button-text">mystry</span>
                </div>
                <div>
                    <span class="uk-button uk-button-text"><?php echo $previewVideoThumb[5]?></span>
                </div>
            </div>
...
<!--********************************************************************** -->
    ...
    <?php
          $seasonprivder =new SeasonProvider($con,$userLogin);
          echo $seasonprivder->create($entity);
    ?>    

    <!-- <div class="uk-child-width-1-6@m uk-margin-small-left uk-margin-medium-right uk-margin-medium-bottom" uk-grid>
